<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userlogin.aspx.cs" Inherits="Train_Management_System.userlogin" %>
      ...
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp"
          ...
          <div class="form-outline mb-4">
            <asp:TextBox ID="textbox1" runat="server" class="form-control form-control-lg" placeholder="Enter User ID" />
            <label class="form-label" for="textbox1">User ID</label>
          </div>
